...
подмодуля) загружены, вызывается конструктор осноговного модуля. Как было сказано выше, конструктор может вернуть
...
Для того что бы можно было удобно подключать модули, как было показано в примерах нужно пределить переменную окружения
...
Самый простой способ напечатать в консоли "Привет мир!", это созда следующий файл конфигурации
